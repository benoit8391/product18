...
function writeData(){
	...
	$sqlstr = "insert into orders (o_name,o_phone,o_cellphone,o_address, orderDate) values('$name','$phone','$cell','$address','$ordate')";
	mysql_query($sqlstr);
