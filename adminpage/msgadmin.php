...
<div id="wrapper"><!-- InstanceBeginEditable name="main" -->
  <div id="main">
    <table width="600" border="0" cellpadding="0" cellspacing="0" id="news_tab">
      <tr>
        <td colspan="3" bgcolor="#666666"><h3>留言管理頁面</h3></td>
      </tr>
      <tr>
        <td width="240" bgcolor="#999999"><h4>留言標題</h4></td>
        <td width="300" bgcolor="#999999"><h4>留言者</h4></td>
        <td width="60" bgcolor="#999999"><h4>編輯</h4></td>
      </tr>

        <tr>
          <td bgcolor="#CCCCCC"><p>&nbsp;</p></td>
          <td bgcolor="#CCCCCC"><p>&nbsp;</p></td>
          <td align="center" bgcolor="#CCCCCC"><p><a href="msgdelete.php?"><img src="../images/icons_img/delete.png" width="20" height="20" class="iconsimg" title="刪除留言" /></a></p></td>
        </tr>
        
    </table>
    <table width="600" border="0" cellpadding="0" cellspacing="0" id="news_tab2">
      <tr>
        <td width="290" bgcolor="#999999"><p>&nbsp;</p></td>
