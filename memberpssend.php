...
<title>芙兒-玩美主義-忘記密碼</title>
<!-- InstanceEndEditable -->
<link href="css/screen.css" rel="stylesheet" type="text/css" media="screen" />
<!-- InstanceBeginEditable name="head" -->
<style type="text/css">
#wrapper #content #right #send_form {
	width: 600px;
	margin-top: 10px;
	margin-right: auto;
	margin-bottom: 10px;
...
#wrapper #content #right #send_form h3 {
...
#wrapper #content #right #send_form p #m_username {
	border: 1px solid #C6C;
	margin: 5px;
}
#wrapper #content #right #send_form p {
	text-align: center;
}
#wrapper #content #right #send_form p #m_send {
	font-family: "新細明體", "Times New Roman";
	font-size: 0.9em;
	color: #FFF;
...
<div id="wrapper">
    ...
    <div id="content">
    	...
    	<!-- InstanceBeginEditable name="contentright" -->
   	  <div id="right">
<p>親愛的會員您好，您的密碼已經寄送至您所填寫的電子郵件信箱中</p>
<p>請至您的電子郵件信箱中收取信件，到您的會員專區中更改您的密碼。</p>
<p>回到<a href="memberlogin.php">登入頁面</a></p>


  <form id="send_form" name="send_form" method="POST">
    <h3>請輸入您當時在本站申請時所登記的電子郵件</h3>
    <p>
      <label for="m_username"></label>
      <input type="text" name="m_username" id="m_username" />
    </p>
    <p>
      <input type="submit" name="m_send" id="m_send" value="送出" />
      </p>
    <p>抱歉！資料庫中並無您所輸入的電子郵件，請重新確認或<a href="memberadd.php">加入會員</a>！</p>
    <p>
    </form>
<p></p>
      </div>
