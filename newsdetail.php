...
<title>芙兒-玩美主義-詳細消息</title>
<!-- InstanceEndEditable -->
<link href="css/screen.css" rel="stylesheet" type="text/css" media="screen" />
<!-- InstanceBeginEditable name="head" -->
<style type="text/css">
#wrapper #content #right #ndetail_tab {
	margin-top: 20px;
	margin-right: auto;
	margin-bottom: 20px;
	margin-left: auto;
...
#wrapper #content #right #ndetail_tab tr td {
	border-top-width: 1px;
	border-right-width: 1px;
	border-bottom-width: 1px;
	border-left-width: 1px;
	...
	border-top-color: #CB65C9;
	border-right-color: #CB65C9;
	border-bottom-color: #CB65C9;
	border-left-color: #CB65C9;
}
#wrapper #content #right #ndetail_tab h3   {
...
#wrapper #content #right #ndetail_tab h4   {
	font-family: "新細明體", "Times New Roman";
	font-size: 0.9em;
	color: #C6C;
	text-align: right;
...
#wrapper #content #right #ndetail_tab tr td p {
	font-family: "新細明體", "Times New Roman";
	font-size: 0.9em;
	color: #680268;
	margin-left: 10px;
...
<div id="wrapper">
    ...
    <div id="content">
    	...
    	<div id="right"><table width="600" border="0" cellpadding="0" cellspacing="0" id="ndetail_tab">
  <tr>
    <td colspan="2"><h3>消息詳細頁面</h3></td>
    </tr>
  <tr>
    <td width="130" id="ndetail_tab"><h4>消息標題：</h4></td>
    <td><p></p></td>
    </tr>
  <tr>
    <td id="ndetail_tab"><h4>發佈日期：</h4></td>
    <td><p></p></td>
    </tr>
  <tr>
    <td id="ndetail_tab"><h4>消息內容：</h4></td>
    <td><p></p></td>
    </tr>
</table>
</div>
